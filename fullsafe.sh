#!/bin/bash
# GnuPG assistant tool
# Dependencies : GnuPG, FZF, sort
#
#    ____             ____   ____
#   / ___|_ __  _   _|  _ \ / ___|
#  | |  _| '_ \| | | | |_) | |  _
...
function checkDirectories() {
	...
	if [ ! -d Documents ]; then
		...
		mkdir -p Documents/pgp/{asc,pub,txt}
	elif [ ! -d Documents/pgp/asc ]; then mkdir Documents/pgp/asc
	elif [ ! -d Documents/pgp/pub ]; then mkdir Documents/pgp/pub
	elif [ ! -d Documents/pgp/txt ]; then mkdir Documents/pgp/txt
	else
		echo "All OK."
	fi
